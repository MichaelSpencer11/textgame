...
public class Monster {
	...
	public Monster(String name, int lvl, int delay, int respawnTime, Room room){
		int randomNess = Random.roll(1,125);
		int randomNessStolen = Random.roll(1,99);
		this.name = name;
		this.level = lvl;
		...
		//stolen items
		if(randomNessStolen >= 1 && randomNessStolen <= 33){
			generatePotionSteals(this.level);
		} else if(randomNessStolen >= 34 && randomNessStolen <= 66){
			generateArmorSteals(this.level);
		} else {
			generateWeaponSteals(this.level);
		}
	...
	public void generateArmorSteals(int level){
		String name;
	...
	public void generateWeaponSteals(int level){
		String name = "";
		int batPow = 0;
		int delay = 0;
		String type = "";
	...
	public void generatePotionSteals(int level){
